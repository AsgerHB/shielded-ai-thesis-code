...
# A query result will either have a non-applicable cost of death, "-", or it will spit out results for all three variations at once.
    ...
    for i in range(10):
        ...
        for runs in [1500, 3000, 6000, 12000]:
            ...
            run_experiment( experiment = "PreShielded",
                            model = "RW__Shielded.xml",            # shield_enabled = true
