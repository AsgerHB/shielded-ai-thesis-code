...
Notebook used for development of the "barbaric" approach to generating a shield. 

A ball is bouncing on a flat surface, and can be hit by a hammer for additional momentum, granted that it is above 4 metres in height. 
...
md"""
## Simulation of the ball at a single point
"""
